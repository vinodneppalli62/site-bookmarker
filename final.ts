...
export class TooltipDirective implements AfterViewInit, OnDestroy {
  ...
  private attachGridListeners(node: HTMLElement): void {
    ...
    this.unlisteners.push(
      this.renderer.listen(node, 'focus', () => {
        this.setTooltipForGrid(node);
      })
    );

    // BLUR
    this.unlisteners.push(
      this.renderer.listen(node, 'blur', () => this.hideTooltip())
    );
  ...
  // ---------------------------------------------------------
  // AG-GRID TOOLTIP LOGIC (SEPARATE + FRESH LOOKUP)
  // ---------------------------------------------------------
  ...
  // ---------------------------------------------------------
  // HOST TOOLTIP LOGIC (SEPARATE + FRESH LOOKUP)
  // ---------------------------------------------------------
